...
-------------------------------------------------------
-- 1️.  data: Defining a Completely New Type
-------------------------------------------------------
...
main1 = print (area (Circle 5))  -- Output: 78.54
...
-------------------------------------------------------
-- 2️. newtype: Defining a Lightweight Wrapper
-------------------------------------------------------
...
main2 = print (getAge (Age 30))  -- Output: 30
...
type Person = (Name, Age2)

getName2 :: Person -> Name
getName2 (n, _) = n

main3= print (getName2 ("Alice", 5))  -- Output: "Alice"
